...
\hypertarget{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example}{}\label{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example}\index{Compute Example@{Compute Example}}
\label{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md23}%
\Hypertarget{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md23}%


 \href{https://github.com/mrsinho/shvulkan}{\texttt{ }}

The compute example demonstrates the setup and execution of a Vulkan-\/based compute shader application. The application starts by initializing Vulkan components, including creating an instance, selecting a physical device, and setting up a logical device with a compute queue. A command pool and command buffer are also created to handle command submissions.\hypertarget{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md24}{}\doxysection{\texorpdfstring{Memory Allocation}{Memory Allocation}}\label{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md24}
The primary objective of this application is to perform computations using a compute shader. The application first prepares memory by setting up staging and device-\/local buffers. The staging buffer is used for host-\/visible memory, allowing the CPU to write data to it. This data includes an array of input values and a factor. This buffer is then copied to a device-\/local buffer, which is optimized for GPU access.\hypertarget{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md25}{}\doxysection{\texorpdfstring{Compute Pipeline}{Compute Pipeline}}\label{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md25}
Next, the compute pipeline is set up. This involves defining descriptor sets and layout bindings, creating and setting up shader modules, and configuring the compute pipeline. The compute shader is responsible for performing operations on the input data. In this example, the shader is designed to square the input values.\hypertarget{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md26}{}\doxysection{\texorpdfstring{Compute Queue Submission}{Compute Queue Submission}}\label{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md26}
Once the pipeline is ready, the application records commands into the command buffer. This includes binding the compute pipeline and descriptor sets, and dispatching compute work to the GPU. After recording, the command buffer is submitted to the compute queue, and the application waits for the operations to complete.\hypertarget{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md27}{}\doxysection{\texorpdfstring{GPU Memory reading and cleanup}{GPU Memory reading and cleanup}}\label{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md27}
...
The application concludes by cleaning up resources, including destroying Vulkan objects and freeing allocated memory.\hypertarget{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md28}{}\doxysection{\texorpdfstring{Terminal output}{Terminal output}}\label{md__c_1_2__home_2desktop_2github_2shvulkan_2docs_2src_2compute__example_autotoc_md28}
